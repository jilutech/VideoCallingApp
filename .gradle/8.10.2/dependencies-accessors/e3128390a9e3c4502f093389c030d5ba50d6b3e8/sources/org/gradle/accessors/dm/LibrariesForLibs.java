...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class StreamLibraryAccessors extends SubDependencyFactory {
        private final StreamVideoLibraryAccessors laccForStreamVideoLibraryAccessors = new StreamVideoLibraryAccessors(owner);

        public StreamLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>stream.video</b>
         */
        public StreamVideoLibraryAccessors getVideo() {
            return laccForStreamVideoLibraryAccessors;
        }

    }

    public static class StreamVideoLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        private final StreamVideoAndroidLibraryAccessors laccForStreamVideoAndroidLibraryAccessors = new StreamVideoAndroidLibraryAccessors(owner);

        public StreamVideoLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>video</b> with <b>io.getstream:stream-video-android-core</b> coordinates and
         * with version reference <b>stream</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> asProvider() {
            return create("stream.video");
        }

        /**
         * Group of libraries at <b>stream.video.android</b>
         */
        public StreamVideoAndroidLibraryAccessors getAndroid() {
            return laccForStreamVideoAndroidLibraryAccessors;
        }

    }

    public static class StreamVideoAndroidLibraryAccessors extends SubDependencyFactory {
        private final StreamVideoAndroidUiLibraryAccessors laccForStreamVideoAndroidUiLibraryAccessors = new StreamVideoAndroidUiLibraryAccessors(owner);

        public StreamVideoAndroidLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>stream.video.android.ui</b>
         */
        public StreamVideoAndroidUiLibraryAccessors getUi() {
            return laccForStreamVideoAndroidUiLibraryAccessors;
        }

    }

    public static class StreamVideoAndroidUiLibraryAccessors extends SubDependencyFactory {

        public StreamVideoAndroidUiLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>compose</b> with <b>io.getstream:stream-video-android-ui-compose</b> coordinates and
         * with version reference <b>stream</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCompose() {
            return create("stream.video.android.ui.compose");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>composeNavigation</b> with value <b>2.8.0-beta01</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>stream</b> with value <b>0.5.8</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getStream() { return getVersion("stream"); }
    ...
    public static class BundleAccessors extends BundleFactory {
        ...
        /**
         * Dependency bundle provider for <b>stream</b> which contains the following dependencies:
         * <ul>
         *    <li>io.getstream:stream-video-android-core</li>
         *    <li>io.getstream:stream-video-android-ui-compose</li>
         * </ul>
         * <p>
         * This bundle was declared in catalog libs.versions.toml
         */
        public Provider<ExternalModuleDependencyBundle> getStream() {
            return createBundle("stream");
        }
